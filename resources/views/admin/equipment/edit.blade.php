                ...
                <div class="container-fluid">
                    ...
                    <div>
                        <div class="d-sm-flex align-items-center justify-content-between mb-4 breadcrumb">
                            <h1 class="h5 mb-0 text-gray-800"><span><a href="{{ route('admin.home') }}" class="fas fa-home"></a> &nbsp;/ Edit Equipment </span></h1>
                    ...
                    <div class="container-xl px-7 mt-9">
                        <div class="row">
                            <div class="col-xl-4">
                                ...
                                <div class="card mb-4 mb-xl-0">
                                    <div class="card-header">Equipment Image</div>
