                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        @foreach ($eqp as $eqpdata)

                                        <tr>
                                            <td hidden>{{ $eqpdata->id }}</td>
                                            <td>{{ $eqpdata->e_category }}</td>
                                            ...
                                            <td>
                                                <div class="actcons">
                                                <button class="btn btn-success btn-sm" title="Edit" data-toggle="modal" data-target="#editModal{{ $eqpdata->id }}">&nbsp;<i class="fas fa-edit"  style="cursor: pointer"></i>&nbsp;</button>&nbsp;
                                                <button class="btn btn-danger btn-sm" title="Delete" data-toggle="modal" data-target="#deleteModal{{ $eqpdata->id }}" data-id="{{ $eqpdata->id }}">&nbsp;<i class="fas fa-trash-alt" >&nbsp;</i></button>&nbsp;
                                                <button class="btn btn-primary btn-sm" title="More Information" data-toggle="modal" data-target="#viewModal{{ $eqpdata->id }}">&nbsp;<i class="fas fa-search"></i>&nbsp;</button>
                                                @include('admin.equipment.editmodal')
                                                @include('admin.equipment.deletemodal')
                                                @include('admin.equipment.viewmodal')
                                                </div>
                                            </td>
                                        </tr>
