            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div>
                        ...
                        <h1 class="h5 mb-0 text-gray-800"><span><a href="{{route('admin.home')}}" class="fas fa-home"></a> &nbsp;/ Rooms </span></h1>
                       <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#exampleModal"><i
                            class="fas fa-download fa-sm text-white-50"></i> Add Room</a>
                            @include('admin.room.createmodal')
                    </div>
                        <!--/.row-->
                                        ...
                                        <div class="card shadow mb-4">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered tbl_pendingres display" id="dataTable" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        @foreach ($eqps as $eqproom)

                                                        <tr>
                                                            <td hidden>{{ $eqproom->id}}</td>
                                                            <td>{{ $eqproom->e_roomname }}  </td>
                                                            <td>
                                                                <div>
